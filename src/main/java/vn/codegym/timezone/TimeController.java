...
public class TimeController {
    ...
    public String getTimeByTimezone(ModelMap model, @RequestParam(name = "rity", required = false, defaultValue = "Asia/Ho_Chi_Minh") String city) {
